  ...
  render() {
    return (
      <div className={classNames(this.props.className, 'Navigation')} role="navigation">
        <a className="Navigation-link" href="/all" onClick={Link.handleClick}>all views</a>
        ...
        <span className="Navigation-spacer"> | <a className="Navigation-link" href="http://blog.octo.com/QQQ">help</a></span>
      </div>
    );
  }
